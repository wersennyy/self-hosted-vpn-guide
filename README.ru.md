...
> *Не просто читаю про сети — собираю, ломаю, настраиваю и разбираюсь, как всё работает на практике.*

Мне 15, и я изучаю сети, Linux и кибербезопасность не только в теории.
...
Здесь я также разбираюсь с `DPI`, блокировками и белыми списками — и проверяю, какие решения работают в реальных сетях.
...
| Раздел | Что найдёшь |
|:--|:--|
| [Начало работы](guide/) | Выбор VPS, первый вход по SSH и базовая подготовка сервера |
| [Защита сервера](guide/) | Обновления, SSH-ключи, firewall и основные меры безопасности |
| [Настройка подключения](guide/) | Развёртывание Xray Core, `VLESS + Reality` и проверка соединения |
| [Клиенты](guide/) | Импорт конфигураций, QR-коды и подключение устройств |
| [Разбор проблем](guide/) | Ошибки, которые встретились мне, и способы их решения |
