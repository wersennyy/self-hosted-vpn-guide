...
3. **Первый шаг к безопасности:** Сразу после развертывания сервера я изменил дефолтный root-пароль на сложный, случайно сгенерированный, чтобы предотвратить атаки перебором.
