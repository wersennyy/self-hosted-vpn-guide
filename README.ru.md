...
Данный репозиторий состоит из многих частей и репозиторий переведен в два языка(русский, английский): 
1.README.md - краткое описание моего проекта и для чего он нужен
2.README.ru.md - тоже самое, только на русском
3.Папка 
---
