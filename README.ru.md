<div align="center">
  <img
    src="https://raw.githubusercontent.com/wersennyy/self-hosted-vpn-guide/fe3135981f67ba38cdd44f9b1dea0d56d2bad743/resources/vpn-wave-header.svg"
    width="100%"
    alt="Self-Hosted VPN"
  />
</div>
...
> * 📁 **[guide](guide/)** —  Супер понятные гайды по полному созданию собственного VPN сервера 
---
> [!CAUTION]
> ### 🚨 ВАЖНО!!!
> Если у вас возникли вопросы, предложения или какие-то ошибки, то обязательно напишите мне в личные сообщения, С радостью попробую вам помочь!!!
...
3. **Первый шаг к безопасности:** Сразу после развертывания сервера я изменил дефолт пароль на свой, случайно сгенерированный, чтобы предотвратить атаки перебором.
4. **Обновление системы:** Я подключился к серверу по SSH и обновил системные пакеты, чтобы убедиться в установке всех патчей безопасности:
   ```bash
...
Чтобы обойти строгие фильтры DPI, я выбрал протокол **VLESS с обфускацией Reality**.
